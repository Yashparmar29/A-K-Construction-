<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <meta name="description"
            content="About A K Construction - 20+ years of excellence in construction. Meet our team and learn about our values.">
            ...
            <div class="container">
                <div class="story-grid fade-in">
                    <div class="story-content">
                        ...
                        <p>Founded in 2012 by AK Parmar, A K Construction started as a small residential contractor in
                            Gujarat. Through unwavering dedication to quality and client satisfaction, we have grown
                            into one of the region's most trusted construction companies.</p>
                        <p style="margin-top:1rem;">Today, we operate across residential, commercial, civil engineering,
                            and renovation sectors — completing 500+ projects with a 98% client satisfaction rate.</p>
            ...
            <div class="container">
                ...
                <div class="mvv-grid">
                    <div class="mvv-card fade-in">
                        ...
                        <h3>Our Mission</h3>
                        <p>To deliver superior construction services that transform our clients' visions into reality,
                            while maintaining the highest standards of quality, safety, and integrity.</p>
                    </div>
                    <div class="mvv-card fade-in">
                        <div class="mvv-icon"><i class="fas fa-eye"></i></div>
                        <h3>Our Vision</h3>
                        <p>To be India's most trusted construction company, recognized for excellence in craftsmanship,
                            innovation in design, and commitment to sustainable building practices.</p>
                    </div>
                    <div class="mvv-card fade-in">
                        <div class="mvv-icon"><i class="fas fa-heart"></i></div>
                        <h3>Our Values</h3>
                        <p>Integrity, Quality, Safety, Innovation, and Client-First approach guide every decision we
                            make from blueprint to final handover.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="footer-grid">
                    <div class="footer-col">
                        <a href="/" class="logo" style="font-size:1.5rem;"><i class="fas fa-hammer"></i> A K
                            Construction</a>
