            ...
            <body class="planner-bg">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark planner-nav sticky-top">
                    <div class="container py-2">
                        <a class="navbar-brand d-flex align-items-center" href="/"
                            style="font-weight: 800; color: var(--yellow);">
                            <i class="fas fa-hammer me-2"></i> A K Construction
                        </a>
                        <div class="ms-auto d-flex align-items-center gap-3">
                            <a href="/planner/dashboard" class="btn btn-gold-outline rounded-pill px-4 btn-sm"><i
                            ...
                            <form id="pdfForm" action="/planner/pdf" method="post" target="_blank" class="m-0">
                                ...
                                <button type="button" class="btn btn-gold rounded-pill px-4 btn-sm"
                ...
                <div class="container py-5 fade-in">
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-5 flex-wrap gap-3">
                        <div>
                            <span class="badge bg-warning text-dark px-3 py-1.5 rounded-pill mb-2 font-weight-bold"
                                style="font-size: 0.75rem;">${property.style} Plan</span>
                            <h1 style="font-weight: 800; color: #fff;" class="mb-1">${property.ownerName}'s Smart House
                                Plan</h1>
                            <p class="text-white-50 mb-0"><i class="fas fa-map-marker-alt me-1 text-warning"></i>
                                Located in ${property.city}, ${property.state}, ${property.country}</p>
                        </div>
                        <div id="architect-approval-container" class="text-end">

                            <span class="text-white-50 d-block mb-1" style="font-size: 0.8rem;">Submitted:
                                <fmt:formatDate value="${property.createdAt}" pattern="dd MMM yyyy" />
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="glass-card p-4 mb-5 border-success border-opacity-50">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div class="d-flex align-items-center">
                                    <div class="text-success me-3" style="font-size: 2.2rem;"><i
                                            class="fas fa-file-signature"></i></div>
                                    <div>
                                        <h5 class="text-white mb-1" style="font-weight: 700;">Official Architect
                                            Blueprint Available</h5>
                                        <p class="text-white-50 mb-0" style="font-size: 0.9rem;">A licensed architect
                                            has verified this plan and uploaded structural engineering drafts.</p>
                                    </div>
                                </div>
                                <a href="${plan.architectDrawingUrl}" class="btn btn-success rounded-pill px-4"
                                    download><i class="fas fa-download me-2"></i> Download Blueprints</a>
                            </div>
                        </div>
                    </c:if>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="glass-card p-4 mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                    <h5 style="color: #fff; font-weight: 700;" class="m-0">
                                        <i class="fas fa-drafting-compass text-warning me-2"></i> Interactive House
                                        Planner
                                    </h5>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <button type="button" class="btn btn-gold btn-tab" id="btn-2d"
                                            onclick="switchView('2d')">
                                            <i class="fas fa-map me-1"></i> 2D Layout
                                        </button>
                                        <button type="button" class="btn btn-gold-outline btn-tab" id="btn-3d"
                                ...
                                <div
                                    class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2 bg-white bg-opacity-5 p-2 rounded-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="text-white-50" style="font-size: 0.85rem;"><i
                                                class="fas fa-layer-group text-warning me-1"></i> Floor
                                            Level:</span>
                                        <select
                                            class="form-select form-select-sm bg-dark text-white border-secondary rounded-pill px-3 py-1"
                                            id="floorSelect" onchange="changeFloorLevel()"
                                    ...
                                    <div class="d-flex align-items-center gap-2" id="dayNightModeContainer"
                                        style="display: none;">
                                        <span class="text-white-50" style="font-size: 0.85rem;"><i
                                                class="fas fa-circle-half-stroke text-warning me-1"></i>
                                            Lighting:</span>
                                        <button type="button"
                                            class="btn btn-sm btn-dark rounded-pill border-secondary text-white px-3"
                                            id="dayNightBtn" onclick="toggleDayNight()" style="font-size: 0.85rem;">
                                ...
                                <div id="canvas-container" style="position: relative; height: 500px;">
                                    <!-- 2D Canvas View -->
                                    <div id="view-2d"
                                        style="width: 100%; height: 100%; position: absolute; top:0; left:0; z-index: 10; display: block;">
                                        <div class="canvas-badge"><i class="fas fa-map me-1"></i> Interactive 2D
                                            Blueprint</div>
                                        <canvas id="canvas-2d"
                                            style="width: 100%; height: 100%; background: #12121e; border-radius: 16px; cursor: grab; display: block;"></canvas>
                                        <div class="canvas-controls">
                                            <button type="button" class="control-btn" onclick="zoom2D(1.2)"
                                                title="Zoom In"><i class="fas fa-plus"></i></button>
                                            <button type="button" class="control-btn" onclick="zoom2D(0.8)"
                                                title="Zoom Out"><i class="fas fa-minus"></i></button>
                                            <button type="button" class="control-btn" onclick="reset2DView()"
                                                title="Reset View"><i class="fas fa-arrows-to-eye"></i></button>
                                        </div>
                                        <div id="hover-card"
                                            style="display: none; position: absolute; background: rgba(18, 18, 18, 0.95); color: #fff; padding: 12px; border-radius: 10px; border: 1.5px solid var(--yellow); pointer-events: none; z-index: 100; max-width: 260px; font-size: 0.8rem; box-shadow: var(--shadow);">
                                            <h6 id="hover-room-name"
                                                style="color: var(--yellow); font-weight: 700; margin-bottom: 4px; font-size: 0.85rem;">
                                                Room</h6>
                                            <div id="hover-room-desc" class="text-white-50" style="line-height: 1.4;">
                                                Dimensions and spatial description.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="view-3d"
                                        ...
                                        <div class="canvas-controls">
                                            ...
                                            <button type="button" class="control-btn" onclick="animateCamera('side')"
                                                title="Side View">S</button>
                                            <button type="button" class="control-btn" onclick="animateCamera('top')"
                                            ...
                                            <button type="button" class="control-btn" id="walkthroughBtn"
                                                onclick="toggleWalkthrough()" title="Walkthrough Mode"><i
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="glass-card p-4 mb-4">
                                <h5 style="color: #fff; font-weight: 700;" class="mb-3"><i
                                        class="fas fa-table-cells text-warning me-2"></i> Room Layout Breakdown</h5>
                            ...
                            <div class="glass-card p-4 mb-4">
                                <h5 style="color: #fff; font-weight: 700;" class="mb-3"><i
                                        class="fas fa-indian-rupee-sign text-warning me-2"></i> Estimated Cost Breakdown
                                </h5>
                                ...
                                <div class="mb-3">
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-layer-group text-warning"
                                                style="width: 14px;"></i> Foundation:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.foundationCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-trowel-bricks text-warning"
                                                style="width: 14px;"></i> Structure (Walls):</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.wallCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-cubes text-warning"
                                                style="width: 14px;"></i> Slab (Roofing):</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.roofCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-bolt text-warning"
                                                style="width: 14px;"></i> Electrical:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.electricalCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-faucet text-warning"
                                                style="width: 14px;"></i> Plumbing:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.plumbingCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-border-all text-warning"
                                                style="width: 14px;"></i> Flooring:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.flooringCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-brush text-warning"
                                                style="width: 14px;"></i> Painting:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.paintingCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-chair text-warning"
                                                style="width: 14px;"></i> Interiors:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.interiorCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-users text-warning"
                                                style="width: 14px;"></i> Labor & wages:</span>
                                        <strong class="text-white">Rs.
                                            <fmt:formatNumber value="${cost.laborCost}" type="number"
                                                maxFractionDigits="0" />
                                        </strong>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="p-3 bg-warning bg-opacity-10 text-warning rounded-3 d-flex justify-content-between align-items-center">
                                    <strong style="font-size: 0.9rem;">TOTAL ESTIMATED COST:</strong>
                                    <strong class="h5 mb-0">Rs.
                                        <fmt:formatNumber value="${cost.totalCost}" type="number"
                                            maxFractionDigits="0" />
                                    </strong>
                                </div>
                            </div>
                            ...
                            <div class="glass-card p-4">
                                <h5 style="color: #fff; font-weight: 700;" class="mb-3"><i
                                        class="fas fa-helmet-safety text-warning me-2"></i> Materials Quantity
                                    Suggestions</h5>

                                <div class="mb-3">
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i
                                                class="fas fa-sack-concrete text-warning-emphasis"></i> Cement
                                            Bags:</span>
                                        <strong class="text-white">${material.cementBags} bags</strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i
                                                class="fas fa-bars-staggered text-warning-emphasis"></i> Steel
                                            Reinforcement:</span>
                                        <strong class="text-white">
                                            <fmt:formatNumber value="${material.steelKg}" maxFractionDigits="0" /> kg
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i
                                                class="fas fa-cubes-stacked text-warning-emphasis"></i>
                                            Bricks/Blocks:</span>
                                        <strong class="text-white">${material.bricksPcs} pcs</strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i
                                                class="fas fa-mountain text-warning-emphasis"></i> Fine Sand:</span>
                                        <strong class="text-white">
                                            <fmt:formatNumber value="${material.sandCft}" maxFractionDigits="0" /> cft
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i
                                                class="fas fa-circle-nodes text-warning-emphasis"></i> Aggregate:</span>
                                        <strong class="text-white">
                                            <fmt:formatNumber value="${material.aggregateCft}" maxFractionDigits="0" />
                                            cft
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i
                                                class="fas fa-fill-drip text-warning-emphasis"></i> Paint:</span>
                                        <strong class="text-white">
                                            <fmt:formatNumber value="${material.paintLiters}" maxFractionDigits="0" />
                                            Liters
                                        </strong>
                                    </div>
                                    <div class="breakdown-list-item">
                                        <span class="breakdown-label"><i class="fas fa-grip text-warning-emphasis"></i>
                                            Floor Tiles:</span>
                                        <strong class="text-white">
                                            <fmt:formatNumber value="${material.tilesSqft}" maxFractionDigits="0" /> sq
                                            ft
                                        </strong>
                                    </div>
                                </div>
                    ...
                    <div class="disclaimer-box mt-5">
                        <h6 style="font-weight: 700; color: #fff;" class="mb-2"><i
                                class="fas fa-circle-exclamation text-danger me-2"></i> PROFESSIONAL ARCHITECTURAL
                            DISCLAIMER</h6>
                        <p class="mb-0">
                            The floor designs, room coordinates, architectural estimations, material lists, and
                            structural budgets generated by this AI Smart House Planner are conceptual calculations
                            only. They are intended for initial references and plan visualizations. This analysis is not
                            a structural blueprint and does not replace site assessments by licensed engineers. Before
                            initiating construction, structural columns, foundation loads, soil compaction, and site
                            limits must be verified, signed, and stamped by a licensed architect and structural engineer
                            in your region. A K Construction holds no liabilities for construction built on these
                            conceptual models.
                        </p>
                    </div>
